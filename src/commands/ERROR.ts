...
export default {
  UNKNOWN_ERROR: function (client: Client, interaction: CommandInteraction) {
  ...
  INVALID_INTERACTION: function (client: Client, interaction: CommandInteraction) {
    const embed = new MessageEmbed()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  PLEASE_TYPE_ARGUMENTS: function (client: Client, interaction: CommandInteraction) {
    const embed = new MessageEmbed()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  INVALID_ARGUMENT: function (client: Client, interaction: CommandInteraction) {
    const embed = new MessageEmbed()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  COOLDOWN_ACTIVATED: function (client: Client, interaction: CommandInteraction) {
    const embed = new MessageEmbed()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  PLEASE_JOIN_VOICE_CHANNEL: function (client: Client, interaction: CommandInteraction) {
    const embed = new MessageEmbed()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  PLEASE_JOIN_SAME_VOICE_CHANNEL: function (client: Client, interaction: CommandInteraction) {
    const embed = new MessageEmbed()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  CAN_NOT_JOIN_VOICE_CHANNEL: function (client: Client, interaction: CommandInteraction) {
    const embed = new MessageEmbed()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  MUSIC_QUEUE_IS_EMPTY: function (client: Client, interaction: CommandInteraction) {
    const embed = new MessageEmbed()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  CAN_NOT_FIND_MUSIC: function (client: Client, interaction: CommandInteraction) {
    const embed = new MessageEmbed()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  CAN_NOT_USE_IN_DM: function (client: Client, interaction: CommandInteraction) {
    const embed = new MessageEmbed()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  GAME_IS_NOT_STARTED: function (client: Client, interaction: CommandInteraction) {
    const embed = new MessageEmbed()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  GAME_IS_ALREADY_STARTED: function (client: Client, interaction: CommandInteraction) {
    const embed = new MessageEmbed()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
