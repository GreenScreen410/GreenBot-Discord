...
export default {
  ...
  INVALID_INTERACTION: function (client: any, interaction: any) {
    const embed = new EmbedBuilder()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  PLEASE_TYPE_ARGUMENTS: function (client: any, interaction: any) {
    const embed = new EmbedBuilder()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  INVALID_ARGUMENT: function (client: any, interaction: any) {
    const embed = new EmbedBuilder()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  COOLDOWN_ACTIVATED: function (client: any, interaction: any) {
    const embed = new EmbedBuilder()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  PLEASE_JOIN_VOICE_CHANNEL: function (client: any, interaction: any) {
    const embed = new EmbedBuilder()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  PLEASE_JOIN_SAME_VOICE_CHANNEL: function (client: any, interaction: any) {
    const embed = new EmbedBuilder()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  CAN_NOT_JOIN_VOICE_CHANNEL: function (client: any, interaction: any) {
    const embed = new EmbedBuilder()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  MUSIC_QUEUE_IS_EMPTY: function (client: any, interaction: any) {
    const embed = new EmbedBuilder()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  MUSIC_IS_PLAYING: function (client: any, interaction: any) {
    const embed = new EmbedBuilder()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  CAN_NOT_FIND_MUSIC: function (client: any, interaction: any) {
    const embed = new EmbedBuilder()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  CAN_NOT_FIND_PREVIOUS_MUSIC: function (client: any, interaction: any) {
    const embed = new EmbedBuilder()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  MUSIC_IS_TOO_LONG: function (client: any, interaction: any) {
    const embed = new EmbedBuilder()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  CAN_NOT_USE_IN_DM: function (client: any, interaction: any) {
    const embed = new EmbedBuilder()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  GAME_IS_NOT_STARTED: function (client: any, interaction: any) {
    const embed = new EmbedBuilder()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
  ...
  GAME_IS_ALREADY_STARTED: function (client: any, interaction: any) {
    const embed = new EmbedBuilder()
      .setColor("#FF0000")
      .setTitle("❌ 오류!")
